...
DBool WinDSVideoCapture::Init(WinDSVideoCaptureSink* pSink)
{
    WinDSCamera::Init();
    ...
    m_sink_filter = new WinDSSinkFilter();
...
DBool WinDSVideoCapture::Start()
{
    ...
    streamConfig->GetStreamCaps(0, &pmt, reinterpret_cast<BYTE*>(&caps)); // Use 0 Index
